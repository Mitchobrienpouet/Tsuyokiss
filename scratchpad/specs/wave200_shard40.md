...
- `SC_M0554_00_M0555_00` — 9 permitted / 21 excluded
...
Total: 139 permitted rows; 41 excluded rows remain absent from all model stages and builds.

## Safety / gates

- Active `state/content_exclusions_wave500_overlay.json` excludes `M0554:4-24` and `M0556:1-20`, including connected bridge lines so filtered scenes resume at self-contained beats.
...
- `M0554` permitted material only establishes the tropical-island mood, confirms Sunao can swim because she attended swimming school, and then notices Heizo has disappeared. The omitted middle is not to be described.
